...
$Password = Read-Host -Prompt 'Please set the standard local admin password defined in Asana' -AsSecureString
...
#set DNS to secure services (should work on most Dell laptops out of the box, else you may need to query the InterfaceAlias
